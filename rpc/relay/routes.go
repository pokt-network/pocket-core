...
func Routes() shared.Routes {
	routes := shared.Routes{
		...
		shared.Route{Name: "DispatchOptions", Method: "OPTIONS", Path: "/v1/dispatch", HandlerFunc: Dispatch},
		...
		shared.Route{Name: "RelayOptions", Method: "OPTIONS", Path: "/v1/relay/", HandlerFunc: Relay},
