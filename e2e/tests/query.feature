Feature: Pocket Query Commands
  ...
  Scenario: To query the list of existing nodes
	...
	When the user runs the command "query nodes" against validator 0
	Then the user should be able to see standard output containing "result"
	Then the user should be able to see standard output containing "address"
	Then the user should be able to see standard output containing "jailed"
	Then the user should be able to see standard output containing "chains"
	Then the user should be able to see standard output containing "service_url"
  ...
  Scenario: To query single param
	...
	Then the user should be able to see standard output containing "pocketcore/MinimumNumberOfProofs"
  ...
  Scenario: To query the list of params
	...
	Then the user should be able to see standard output containing "param_key"
	Then the user should be able to see standard output containing "param_value"
  ...
  Scenario: To get supplies
	...
	Then the user should be able to see standard output containing "app_staked"
  ...
  Scenario: To get existing supported networks
	...
	Then the user should be able to see standard output containing "0011"
