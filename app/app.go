...
const appName = "pocketcore"

var (
	// default home directories for the application CLI
	DefaultCLIHome = os.ExpandEnv("$HOME/.pcli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.pcd")
...
func (app *pocketCoreApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
