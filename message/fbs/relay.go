...
func RelayAddNetworkID(builder *flatbuffers.Builder, NetworkID flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(NetworkID), 0)
}
