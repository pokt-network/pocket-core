...
type PocketConfig struct {
	...
	ClientSessionBlockSyncAllowance int64  `json:"client_session_block_sync_allowance"`
...
const (
	...
	DefaultSessionBlockSyncAllowance   = 1 // 1 session (irrespective of num blocks per session)
...
func DefaultConfig(dataDir string) Config {
	c := Config{
		...
		PocketConfig: PocketConfig{
			...
			ClientSessionBlockSyncAllowance: DefaultSessionBlockSyncAllowance,
