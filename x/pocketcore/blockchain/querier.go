...
func NewQuerier(nk NodeKeeper, ak ApplicationKeeper) sdk.Querier {
	return func(ctx sdk.Context, path []string, req abci.RequestQuery) (res []byte, err sdk.Error) {
		switch path[0] {
		case QueryNode:
			return queryNode(ctx, path[1:], req, nk)
		case QueryNodes:
			return queryNodes(ctx, req, nk)
		case QueryApplication:
			return queryApplication(ctx, path[1:], req, ak)
		case QueryApplications:
			return queryApplications(ctx, req, ak)
		default:
